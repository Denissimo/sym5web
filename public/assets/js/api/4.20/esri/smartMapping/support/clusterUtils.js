...
vvType:a.type}}function z(b){return b.map(a=>{var c=String(a.value);a=(a=String(a.label))?a.replace(/"/g,'\\"'):"";return`{
  ...
  return label;
  `};d.getRendererAttributeInfo=r;d.getStatisticId=p;d.getStatisticInfo=m;d.getStatisticInfos=function(b,a,c=!0){const e=[],f=r(b,a);"class-breaks"===a.type?e.push(m(f,"avg")):"unique-value"===a.type&&e.push(m(f,"type"));a=x.getPrimaryVisualVariables(a);for(const k of a)a=t(b,k),e.push(m(a,"avg"));return c?u.unique(e,(k,l)=>k.statisticHash===l.statisticHash):e};d.getVariableAttributeInfo=t;Object.defineProperty(d,"__esModule",{value:!0})});